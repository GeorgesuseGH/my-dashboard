...
<h2 className=" text-2xl text-center bg-linear-to-t from-purple-700 via-pink-300 to-purple-700 w-full font-bold" > NextBoard , providing you with your finance metrics!</h2>
